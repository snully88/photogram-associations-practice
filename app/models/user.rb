...
class User < ApplicationRecord
  ...
  has_many(:accepted_sent_follow_requests, -> {where status: "accepted"}, class_name: "FollowRequests", foreign_key: "sender_id")
  ...
  has_many(:accepted_recieved_follow_requests, -> {where status: "accepted"}, class_name: "FollowRequests", foreign_key: "recipient_id")
  ...
  has_many(:leaders, through: :accepted_sent_follow_requests, source: :recipients)
